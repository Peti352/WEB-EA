...
*(Képernyőkép: phpMyAdmin a Nethely tárhelyen a `filmek` tábla tartalmával.)*
...
*(Képernyőkép: az index.html böngészőben megnyitva, a hero szekció és a feature grid látszik.)*
...
*(Képernyőkép: javascript.html CRUD működés közben – űrlap + film táblázat.)*
...
*(Képernyőkép: react.html a böngészőben, az iframe-ben a React app.)*
...
*(Képernyőkép 1: spa.html – Kalkulátor nézet.)*
*(Képernyőkép 2: spa.html – Tic-Tac-Toe egy játszma közben.)*
...
*(Képernyőkép: fetchapi.html – sikeres hozzáadás után az új rekord megjelenik a listában.)*
*(Képernyőkép: DevTools Network tab – a POST hívás és a JSON válasz.)*
...
*(Képernyőkép: axios.html – a React komponens az iframe-ben, CRUD műveletek.)*
...
*(Képernyőkép: oojs.html – mozgó körök és csillagok a vásznon.)*
...
*(Képernyőkép: Total Commander vagy WinSCP FTP kapcsolat a tárhellyel.)*
...
| **FTP host** | `<kitöltendő>` |
| **FTP user** | `<kitöltendő>` |
| **FTP password** | `<kitöltendő>` |
| **DB host** | `localhost` |
| **DB name** | `<kitöltendő>` |
| **DB user** | `<kitöltendő>` |
| **DB password** | `<kitöltendő>` |
...
*(Képernyőkép: GitHub commit history – min. 5 commit, időben eloszlik.)*
